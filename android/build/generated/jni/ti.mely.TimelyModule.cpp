...
void TimelyModule::bindProxy(Local<Object> exports, Local<Context> context)
{
...
void TimelyModule::dispose(Isolate* isolate)
{
	LOGD(TAG, "dispose()");
...
Local<FunctionTemplate> TimelyModule::getProxyTemplate(Isolate* isolate)
{
	if (!proxyTemplate.IsEmpty()) {
	...
	Local<String> nameSymbol = NEW_SYMBOL(isolate, "Timely");
