...
void TimerProxy::bindProxy(Local<Object> exports, Local<Context> context)
{
...
Local<FunctionTemplate> TimerProxy::getProxyTemplate(Isolate* isolate)
{
	if (!proxyTemplate.IsEmpty()) {
	...
	Local<String> nameSymbol = NEW_SYMBOL(isolate, "Timer");
...
void TimerProxy::start(const FunctionCallbackInfo<Value>& args)
{
	...
	static jmethodID methodID = NULL;
	if (!methodID) {
		methodID = env->GetMethodID(TimerProxy::javaClass, "start", "(Ljava/util/HashMap;)V");
		if (!methodID) {
